...
|[**membersListMembers**](#memberslistmembers) | **GET** /api/v1/members/ | List Members|
...
# **membersListMembers**
> Array<MemberRead> membersListMembers()
...
const { status, data } = await apiInstance.membersListMembers(
    teamId
);
```
